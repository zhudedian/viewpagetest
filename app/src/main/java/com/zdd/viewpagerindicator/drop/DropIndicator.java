package com.zdd.viewpagerindicator.drop;
...
import com.zdd.viewpagerindicator.R;
...
public class DropIndicator extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < tabNum; i++) {
            View child = getChildAt(i);
            child.layout((int) (div + (1 - scale * 1 / g2) * radius + i * (div + 2 * radius)), (int) (startY - scale * radius / g2*2), (int) (div + (1 + scale * 1 / g2) * radius + i * (div + 2 * radius)), (int) (startY + scale * radius / g2*2));
        }
    }
